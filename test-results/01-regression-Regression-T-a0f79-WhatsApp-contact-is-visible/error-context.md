...
- Name: 01-regression.spec.js >> Regression Tests - Home Page >> 19. WhatsApp contact is visible
- Location: tests\playwright\01-regression.spec.js:100:3
...
Locator: locator('text=WhatsApp, a[href*="whatsapp"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=WhatsApp, a[href*="whatsapp"]').first()
